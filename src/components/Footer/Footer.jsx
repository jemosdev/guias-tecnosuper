    ...
    return (
        <footer>
            <Col md={12}>
                ...
                <section className="footer-contact text-light">
                        <span><FontAwesomeIcon icon={faInstagram} className="icon-Instagram" /></span>
                        <div>tecnosuperlogo</div>
                        <div><FontAwesomeIcon icon={faFacebook} /></div><p>@tecnosuper.co</p>
                    </section>
